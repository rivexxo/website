      ...
      <div class="row">
        <div class="col-xs-12 col-sm-3 col-md-3">
          ...
          <ul class="footer-menu classic">
            <li class="menu-item"><a href="https://portal.dpitsolutions.nl/cart.php?gid=1">Shared Hosting</a></li>
            ...
            <li class="menu-item"><a href="https://portal.dpitsolutions.nl/cart.php?a=add&domain=register">Domain Names</a></li>
          </ul>
        </div>
        <div class="col-xs-12 col-sm-3 col-md-3">
          <div class="heading">Support</div>
          <ul class="footer-menu classic">
            <li class="menu-item"><a href="https://portal.dpitsolutions.nl/clientarea.php">myRivexxo</a></li>
            <li class="menu-item"><a href="https://portal.dpitsolutions.nl/index.php?rp=/knowledgebase">Knowledge Base</a></li>
            <li class="menu-item"><a href="https://portal.dpitsolutions.nl/contact.php">Contact Us</a></li>
            <li class="menu-item"><a href="https://portal.dpitsolutions.nl/index.php?rp=/knowledgebase">FAQ</a></li>
          </ul>
        </div>
        <div class="col-xs-12 col-sm-3 col-md-3">
        ...
        <div class="col-md-6 col-lg-6">
          <ul class="footer-menu">
            <li class="menu-item by c-grey ml-0">Hybrid Design With ♥ by
              <a href="https://dpitsolutions.nl/" target="_blank">D&P IT Solutions</a>
            </li>
          </ul>
        </div>
        <div class="col-md-6 col-lg-6">
