          ...
          <nav id="nav" class="navbar navbar-default navbar-main" role="navigation">
            ...
            <div class="collapse navbar-collapse" id="primary-nav">
              <ul class="nav navbar-nav">
                ...
                <li class="infos">
                  <a href="tel:+0000000000"><p class="c-grey">Phone: + (031) 023-234-0666</p></a>
                  <a href="mailto:antler@mail.com"><p class="c-grey">Email: info@rivexxo.com</p></a>
        ...
        <div class="vc-child">
          <div class="top-banner">
            <div class="container">
              ...
              <h3 class="subheading">Powerful servers with high-end resources <br>that will guarantee resource exclusivity, <br>starting at just <b class="c-pink">€55.00/mo</b><br>
              </h3>
        ...
        <div class="vc-child">
          <div class="top-banner">
            <div class="container">
              ...
              <h3 class="subheading">Search a domain of your choice from <b class="c-pink">€3.95/yr</b></h3>
              <div class="row">
              ...
              <div class="domain-prices">
                <ul>
                  <li class="tld">.com <div class="price"><sup>€</sup>11.49</div></li>
                  <li class="tld">.net <div class="price"><sup>€</sup>12.40</div></li>
                  <li class="tld">.org <div class="price"><sup>€</sup>9.00</div></li>
                  <li class="tld">.nl <div class="price"><sup>€</sup>3.95</div></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="col-sm-12 col-md-4 col-lg-4">
          <div class="wrapper first text-left">
            <div class="top-content">
              ...
              <div class="price"><sup>€</sup>18.15 <span class="period">/month</span></div>
              <a href="cart.php?gid=1" class="btn btn-default-yellow-fill">All plans</a>
            </div>
            <ul class="list-info">
              <li><i class="icon-drives"></i> <span class="c-purple">DISK</span><br> <span>20GB SSD</span></li>
              <li><i class="icon-speed"></i> <span class="c-purple">DATA</span><br> <span>Unlimited Bandwidth</span></li>
              <li><i class="icon-emailopen"></i> <span class="c-purple">EMAIL</span><br> <span>Unlimited mails accounts</span></li>
              <li><i class="icon-domains"></i> <span class="c-purple">TLD</span><br> <span>Free .nl domain</span></li>
            </ul>
          </div>
        </div>
        <div class="col-sm-12 col-md-4 col-lg-4">
          <div class="wrapper text-left">
            ...
            <div class="top-content">
              ...
              <div class="price"><sup>€</sup>55.00 <span class="period">/month</span></div>
              <a href="http://inebur.com/antler/template/configurator" class="btn btn-default-yellow-fill">Configure</a>
            </div>
            <ul class="list-info bg-purple">
              <li><i class="icon-cpu"></i> <span class="c-pink">CPU</span><br> <span>2x 1.80Ghz 4 Cores</span></li>
              <li><i class="icon-ram"></i> <span class="c-pink">RAM</span><br> <span>8GB</span></li>
              <li><i class="icon-drivessd"></i> <span class="c-pink">DRIVES</span><br> <span>1 x 64GB SSD</span></li>
              <li><i class="icon-git"></i> <span class="c-pink">UPLINK</span><br> <span>1Gbps</span></li>
            </ul>
          </div>
        </div>
        <div class="col-sm-12 col-md-4 col-lg-4">
          <div class="wrapper third text-left">
            <div class="top-content">
              ...
              <div class="fromer">Starting at:</div>
              <div class="price"><sup>€</sup>14.99 <span class="period">/month</span></div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-12">
          <div class="wrapper">
            <h1 class="heading">D&P IT Solutions</h1>
            <h3 class="subheading">Innovatieve ICT dienstverlening voor de kleine MKB.</h3>
          </div>
        </div>
      </div>
    </div>
